...
export default function ListSoftwarePage() {
  ...
  const steps = [
    { number: 1, title: 'Software Information', description: 'Basic details and company info' },
    { number: 2, title: 'Features & Pricing', description: 'Software features and pricing model' },
    { number: 3, title: 'Technical Details', description: 'Platform, integrations, and technical specs' },
          ...
          <div className="flex h-16 items-center justify-between">
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-muted-foreground -mt-1">List Your Software</span>
              </div>
            </motion.button>
      ...
      <Section className="py-20 bg-gradient-to-br from-primary/5 via-background to-primary/5">
        <Container>
          ...
          >
            ...
            >
              Showcase your software solution to thousands of businesses looking for the perfect tool. Get discovered and grow your user base.
            </motion.p>
          ...
          >
            ...
            >
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Discover the benefits of listing your software on our platform.
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  description: "Get discovered by thousands of businesses actively searching for software solutions.",
                  color: "text-primary",
                ...
                },
                {
                  ...
                  description: "Showcase user reviews and ratings to build trust with potential customers.",
                ...
                },
                {
                  ...
                  description: "Connect with qualified leads and expand your customer base.",
                    ...
                    {currentStep === 1 && (
                      <div className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div>
                            <label className="text-sm font-medium text-foreground mb-2 block">Software Name *</label>
                            <Input 
                              name="softwareName"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          ...
                          <div>
                            ...
                            <Input 
                              ...
                              onChange={handleInputChange}
                              placeholder="contact@yoursoftware.com"
                              className="border-border/50 focus:border-primary/50"
                              required
                            />
                          </div>
                        ...
                        <div>
                          <label className="text-sm font-medium text-foreground mb-2 block">Software Description *</label>
                          <Textarea 
                            name="description"
                            value={formData.description}
                            onChange={handleInputChange}
                            placeholder="Describe your software, its purpose, and key benefits..."
                      ...
                      <div className="space-y-6">
                        <div>
                          ...
                          <Textarea 
                            ...
                            onChange={handleInputChange}
                            placeholder="List the main features and capabilities of your software..."
                            className="border-border/50 focus:border-primary/50 min-h-[120px]"
                            required
                          />
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          ...
                          <div>
                            <label className="text-sm font-medium text-foreground mb-2 block">Deployment</label>
                            <select 
                              name="deployment"
                        ...
                        <div>
                          <label className="text-sm font-medium text-foreground mb-2 block">Integrations</label>
                          <Textarea 
                            name="integrations"
                            value={formData.integrations}
                            onChange={handleInputChange}
                            placeholder="List popular integrations (e.g., Salesforce, Slack, Google Workspace)..."
                        ...
                        <div>
                          ...
                          <Textarea 
                            ...
                            onChange={handleInputChange}
                            placeholder="Describe your target audience (e.g., small businesses, enterprises, specific industries)..."
                            className="border-border/50 focus:border-primary/50 min-h-[100px]"
                          />
                        </div>
                      </div>
                    ...
                    {currentStep === 3 && (
                      <div className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          ...
                          <div>
                            <label className="text-sm font-medium text-foreground mb-2 block">Programming Language</label>
                            <Input 
                        ...
                        <div className="space-y-4">
                          <h4 className="text-lg font-semibold text-foreground">Additional Features</h4>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="flex items-center space-x-3">
                              ...
                              />
                              <label className="text-sm font-medium text-foreground">API Available</label>
                            </div>
                            <div className="flex items-center space-x-3">
                              <input
                                type="checkbox"
                                ...
                                className="rounded border-border/50"
                              />
                              <label className="text-sm font-medium text-foreground">Mobile App Available</label>
                            </div>
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="border-2 border-dashed border-border/50 rounded-lg p-6 text-center hover:border-primary/50 transition-colors duration-200">
                            ...
                            <p className="text-muted-foreground mb-2">Upload software screenshots, logos, and demos</p>
                      ...
                      <div className="space-y-6">
                        <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                          ...
                          <div className="space-y-3 text-sm">
                            <div className="flex justify-between">
                              ...
                              <span className="font-medium">{formData.softwareName || 'Not provided'}</span>
                            </div>
                            <div className="flex justify-between">
                            ...
                            <div className="flex justify-between">
                              ...
                              <span className="font-medium">{formData.pricing || 'Not provided'}</span>
                            </div>
                            <div className="flex justify-between">
                        ...
                        <div className="bg-muted/50 rounded-lg p-4">
                          ...
                          <p className="text-sm text-muted-foreground mb-4">
                            ...
                            Your software listing will be reviewed and approved within 24-48 hours.
                          </p>
        ...
        <Container>
          ...
          >
            ...
            >
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Simple steps to get your software listed and visible to potential users.
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {[
                { 
                  ...
                  description: "Fill out the form with your software details and information.",
                  color: "text-primary",
                  bgColor: "bg-primary/10"
                },
                { 
                ...
                { 
                  icon: TrendingUp, 
                  title: "Start Growing", 
                  description: "Begin receiving inquiries and growing your user base.",
          ...
          >
            ...
            >
              ...
              <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                Join thousands of software solutions already listed on our platform. Start your listing today!
              </p>
